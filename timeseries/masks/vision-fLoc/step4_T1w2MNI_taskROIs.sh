...
PARCELPATH="/home/mstlaure/projects/rrg-pbellec/mstlaure/cneuromod_extract_tseries/masks/vision-fLoc"  # /path/to/infile_MNI.nii
...
for SUBNUM in 01 02 03
do
  for ROINAME in bodyEBA faceFFA faceOFA facepSTS sceneMPA sceneOPA scenePPA
  do
    antsApplyTransforms --default-value 0 --dimensionality 3 --float 0 \
    --input ${PARCELPATH}/tpl-sub${SUBNUM}T1w/tpl-sub${SUBNUM}T1w_res-func_atlas-fLocVisionTask_label-${ROINAME}_mask.nii.gz \
    --interpolation NearestNeighbor \
    --output ${PARCELPATH}/tpl-MNI152NLin2009cAsym/tpl-MNI152NLin2009cAsym_sub-${SUBNUM}_res-anat_atlas-fLocVisionTask_label-${ROINAME}_mask.nii.gz \
