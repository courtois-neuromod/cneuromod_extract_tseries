...
do
  ...
  --input ${DATADIR}/sub-${SUBNUM}_space-T1w_label-GM_dseg_FLOAT.nii.gz --interpolation Linear \
  --output ${DATADIR}/sub-${SUBNUM}_space-MNI152NLin2009cAsym_label-GM_probseg_FSLinear.nii.gz \
