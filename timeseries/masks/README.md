...
* ``step5_upsample10k_parcellation.py``. Script applies Ward parcellation algorithm within grey matter mask to produce 10k parcels in MNI space and assigns each of them to the Schaefer18_1000Parcels7Networks parcel with which is shares the most voxels.
